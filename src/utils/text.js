...
1. 개인정보의 처리 목적 <누구게>(‘https://www.heartsignal.dev’이하 ‘누구게’) 은(는) 다음의 목적을 위하여 개인정보를 처리하고 있으며, 다음의 목적 이외의 용도로는 이용하지 않습니다.
...
① <누구게>(‘https://www.heartsignal.dev’이하 ‘누구게’) 은(는) 정보주체로부터 개인정보를 수집할 때 동의 받은 개인정보 보유․이용기간 또는 법령에 따른 개인정보 보유․이용기간 내에서 개인정보를 처리․보유합니다.
...
① <누구게>('https://www.heartsignal.dev'이하 '누구게')은(는) 정보주체의 동의, 법률의 특별한 규정 등 개인정보 보호법 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.

② <누구게>('https://www.heartsignal.dev')은(는) 다음과 같이 개인정보를 제3자에게 제공하고 있습니다.
...
① <누구게>('누구게')은(는) 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.

1. <>
위탁받는 자 (수탁자) :
위탁하는 업무의 내용 :
위탁기간 :
② <누구게>('https://www.heartsignal.dev'이하 '누구게')은(는) 위탁계약 체결시 개인정보 보호법 제25조에 따라 위탁업무 수행목적 외 개인정보 처리금지, 기술적․관리적 보호조치, 재위탁 제한, 수탁자에 대한 관리․감독, 손해배상 등 책임에 관한 사항을 계약서 등 문서에 명시하고, 수탁자가 개인정보를 안전하게 처리하는지를 감독하고 있습니다.
...
① 정보주체는 누구게(‘https://www.heartsignal.dev’이하 ‘누구게) 에 대해 언제든지 다음 각 호의 개인정보 보호 관련 권리를 행사할 수 있습니다.
...
① <누구게>('https://www.heartsignal.dev'이하 '누구게')은(는) 다음의 개인정보 항목을 처리하고 있습니다.

1<휴대전화 번호 보관>
필수항목 : 휴대전화번호
- 선택항목 :

7. 개인정보의 파기<누구게>('누구게')은(는) 원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이 해당 개인정보를 파기합니다. 파기의 절차, 기한 및 방법은 다음과 같습니다.
...
누구게 은 정보주체의 이용정보를 저장하고 수시로 불러오는 ‘쿠키’를 사용하지 않습니다.


9. 개인정보 보호책임자 작성

① 누구게(‘https://www.heartsignal.dev’이하 ‘누구게) 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.

▶ 개인정보 보호책임자
성명 :권태형
직책 :대표
직급 :대표
연락처 :0218772312, nuguge327@gmail.com,
※ 개인정보 보호 담당부서로 연결됩니다.
...
담당자 :
연락처 :
② 정보주체께서는 누구게(‘https://www.heartsignal.dev’이하 ‘누구게) 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 누구게(‘https://www.heartsignal.dev’이하 ‘누구게) 은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.
...
11. 개인정보의 안전성 확보 조치 <누구게>('누구게')은(는) 개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에 필요한 기술적/관리적 및 물리적 조치를 하고 있습니다.
...
제1조 (목적) 이 약관은 '누구게'(이하 “회사”라 합니다)가 모바일 기기를 통해 제공하는 게임 서비스 및 이에 부수하는 네트워크, 웹사이트, 기타 서비스(이하 “서비스”라 합니다)의 이용에 대한 회사와 서비스 이용자의 권리ㆍ의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
